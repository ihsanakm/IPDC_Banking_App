...
const Footer = () => {
  return (
    <section className="flex justify-center">
      <div className="flex gap-24 my-[3.75rem] ml-[8.44rem]">
        <div className="max-w-[11.25rem] ">
          <h5 className="text-[0.9rem] font-semibold mb-5">About the company</h5>
        ...
        <div>
          ...
          <ul>
            <li className="font-medium text-[0.89rem] text-[#676767] ">Careers</li>
            <li className="font-medium text-[0.89rem] text-[#676767] mt-3">
              Contact Us
            </li>
            <li className="font-medium text-[0.89rem] text-[#676767] mt-3">
            ...
            <li className="font-medium text-[0.89rem] text-[#676767] mt-3">NIS</li>
          </ul>
        </div>
        <div>
      ...
      <div className="flex mt-[4rem] ml-[12rem]">
